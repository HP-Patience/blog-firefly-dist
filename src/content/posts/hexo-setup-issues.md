...
md文档内，使用`<!-- broken image removed: 图片链接地址 -->`的格式，圆括号内的链接地址写`(/images/name.jpeg)`。
...
例如，将“1.jpeg”这个图片资源放在该文件夹中，并在.md文件中像这样引用图片：`<!-- broken image removed: 1.jpeg -->`，这个方法在资源较多时方便管理。
